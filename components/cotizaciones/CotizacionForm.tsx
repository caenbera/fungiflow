      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
              ...
              <div key={field.id} className="space-y-1">
                ...
                {subtotal > 0 && (
                  <p className="text-xs text-right text-muted-foreground pr-7">
                    Subtotal: <span className="font-semibold text-foreground">{formatAmount(subtotal)} <CurrencyFlag currency={currency} /></span>
                  </p>
                )}
              </div>
            );
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-2xl font-bold text-green-700">{formatAmount(total)} <CurrencyFlag currency={currency} /></p>
          </div>
