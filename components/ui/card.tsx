...
function CardTitle({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "text-base leading-snug font-semibold text-[#3D2B1F] group-data-[size=sm]/card:text-sm",
        className
      )}
      {...props}
    />
...
function CardFooter({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "flex items-center border-t border-[#D9CBB8]/70 bg-[#ECE4DA]/55 p-(--card-spacing)",
        className
      )}
      {...props}
    />
