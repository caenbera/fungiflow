...
import { Users, UserCheck, TrendingUp, Receipt, RefreshCw, AlertTriangle } from 'lucide-react';
import { KPIS_CLI } from './mock-data';

const ICONS = [Users, UserCheck, TrendingUp, Receipt, RefreshCw, AlertTriangle];
