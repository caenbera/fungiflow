      ...
      <div className="flex-1 flex flex-col items-center justify-center px-8 py-12 bg-[#FAF7F2] dark:bg-[#120a04] relative overflow-hidden">
        ...
        <div className="w-full max-w-sm relative z-10">
          ...
          <div className="flex justify-center mb-8 lg:hidden">
            ...
            <img src="https://i.postimg.cc/DzDbvHmK/logo-original.png" alt="FungiFlow" className="w-24 h-24 object-contain" />
          </div>

          {/* Heading */}
          <div className="mb-8">
            <p className="text-sm font-medium text-[#7a4010] dark:text-[#c07040] mb-1">Crea tu cuenta en</p>
            <h1
            ...
            <p className="mt-2 text-sm text-[#8a7060] dark:text-[#9a7a5a]">
              Empieza a gestionar tu cultivo hoy
            </p>
          </div>
